...
!(function (e, t) {
	...
	var Te = createCommonjsModule(function (e, r) {
		...
		Object.defineProperty(r, '__esModule', {
			...
			(r.atob = memoize(function (e) {
				return isNodeEnvironment()
					? Ee.default.from(e, 'base64').toString('ascii')
					: window.atob(e);
			})),
			(r.btoa = memoize(function (e) {
				return isNodeEnvironment()
					? Ee.default.from(e).toString('base64')
					: window.btoa(e);
			})),
			(r.memoize = memoize),
			(r.urlEncodeParameters = function (e) {
				return e
					? Object.keys(e).reduce(function (t, r) {
							var i = e[r];
							return i.constructor === Object
	...
	Te.generateUUID,
		Te.isLibraryType,
		Te.isNodeEnvironment,
		Te.atob,
		Te.btoa,
		Te.memoize,
		Te.urlEncodeParameters,
		Te.getArtworkFromURL,
		Te.throttled,
		Te.debounce;
	...
	unwrapExports(Oe);
	Oe.arrayBufferToString,
		Oe.base64ToUint8Array,
		Oe.ensureArray,
		Oe.stringToHashCode,
		Oe.stringToUint8Array,
		Oe.stringToUint16Array,
		Oe.uint8ArrayToBase64;
							...
							return o(this, function (o) {
								switch (o.label) {
									...
									case 1:
										return (
											o.trys.push([1, 3, , 4]),
											[4, r.apply(null, Oe.ensureArray(e.params))]
										);
									case 2:
										return (
											(n = o.sent()),
					...
					return (
						...
						a(this, void 0, void 0, function () {
							...
							return s(this, function (s) {
								return (
									(o = (window.location && window.location.href) || ''),
											...
											(a.dispatch = new Me.Dispatch({
												methods: {
													...
													thirdPartyInfo: function () {
														return a._thirdPartyInfo(
															a.developerToken,
															Object.assign(a.deeplinkParameters, e)
														);
													},
	...
	unwrapExports(Le);
	Le.AuthorizationStatus,
		Le.validateToken,
		Le.ACTIVATE_REQUEST_URL,
		Le.AUTHENTICATE_REQUEST_URL,
		Le.SERVICE_URL,
		Le.SUBSCRIBE_URL,
		Le.WHITELIST_DOMAIN_REGEX,
		Le.ServiceSetupAction,
		Le.ServiceSetupView;
		...
		Ue =
			...
			createCommonjsModule(function (e, r) {
				...
				Object.defineProperty(r, '__esModule', {
					...
					(r.validateToken = Le.validateToken),
					(r.AuthorizationStatus = Le.AuthorizationStatus),
					(function (e) {
				...
				var u = (function (e) {
					function StoreKit(t, r) {
						...
						return (
							...
							(i._authorizationStatus = Le.AuthorizationStatus.NOT_DETERMINED),
							...
							(i._developerToken = new Ie.DeveloperToken(t)),
							(i._serviceSetupView = new Le.ServiceSetupView(t, {
							...
							i.userTokenIsValid &&
								...
								(i._authorizationStatus = i.restrictedEnabled
									? Le.AuthorizationStatus.RESTRICTED
									: Le.AuthorizationStatus.AUTHORIZED)),
					...
					return (
						...
						(StoreKit.prototype.itunesDeeplinkURL = function (e) {
							return (
								...
								(e = Object.assign(this.deeplinkParameters || {}, e)),
								'https://itunes.apple.com/deeplink?' + De.buildQueryParams(e)
							);
						}),
									...
									switch (t.label) {
										case 0:
											return this.storefrontIdentifier
												...
												: [
														4,
														Ne.Storefront.inferFromLanguages(
															this.developerToken
														),
												  ];
										case 1:
						...
						(StoreKit.prototype._removeStorageItem = function (e) {
							return 'cookie' === this.persist
								? Ce.setCookie(btoa(e), '', '/', 0)
								: 'localstorage' === this.persist
								? this.storage.removeItem(e)
								: void 0;
						}),
						(StoreKit.prototype._reset = function (e) {
							void 0 === e && (e = Le.AuthorizationStatus.NOT_DETERMINED),
								(this._authorizationStatus = e),
								(this._cid = void 0),
	...
	var qe = createCommonjsModule(function (e, r) {
		...
		var c = (function (e) {
			function TokenSession(t, r, i, n) {
				...
				return (
					(o._developerToken = new Ve.DeveloperToken(r)),
				...
				return (
					...
					(DataStore.prototype.populateDataRecords = function (e, t, r) {
						...
						return (
							...
							Ye.ensureArray(e.data).map(function (e) {
								var n = i._materializeRecord(e.type, e.id, t);
								return (
									r && Object.assign(e, He.transform(r, e)),
									e.attributes
		...
		rt = (function () {
			function LocalDataStore() {
				(this.enableDataStore = !!we.features['api-data-store']),
					this.enableDataStore && (this._store = new tt());
			}
			return (
					...
					return __awaiter(this, void 0, void 0, function () {
						return __generator(this, function (r) {
							return (
								...
								[2, this.resource(et.Catalog, 'albums', e, t)]
							);
						});
					});
				}),
				(API.prototype.albumRelationship = function (e, t, r) {
					return __awaiter(this, void 0, void 0, function () {
						return __generator(this, function (i) {
							return [
								2,
								this.collection(et.Catalog, 'albums/' + e + '/' + t, void 0, r),
							];
						});
					});
				}),
				(API.prototype.albums = function (e, t) {
					return __awaiter(this, void 0, void 0, function () {
						return __generator(this, function (r) {
							return (
								(t = this.equivalentParameters(t, 'extend[songs]')),
								[2, this.collection(et.Catalog, 'albums', e, t)]
							);
						});
					});
				}),
					...
					return __awaiter(this, void 0, void 0, function () {
						...
						return __generator(this, function (i) {
							return !!!we.features['api-artist-include'] &&
								...
								: [2, this.resource(et.Catalog, 'artists', e, t)];
						});
					});
				}),
					...
					return __awaiter(this, void 0, void 0, function () {
						return __generator(this, function (r) {
							return (
								...
								[2, this.resource(et.Catalog, 'music-videos', e, t)]
							);
						});
					});
				}),
				(API.prototype.musicVideos = function (e, t) {
					return __awaiter(this, void 0, void 0, function () {
						return __generator(this, function (r) {
							return (
								(t = this.equivalentParameters(t)),
								[2, this.collection(et.Catalog, 'music-videos', e, t)]
							);
						});
					});
				}),
						...
						return __generator(this, function (i) {
							switch (i.label) {
								case 0:
									return [
										4,
										this.collection(et.Personalized, 'recommendations', e, t),
									];
								case 1:
									(r = i.sent()),
					...
					return __awaiter(this, void 0, void 0, function () {
						...
						return __generator(this, function (i) {
							return (
								...
								[2, this.collection(et.Catalog, 'search', void 0, r)]
							);
						});
					});
				}),
					...
					return __awaiter(this, void 0, void 0, function () {
						...
						return __generator(this, function (i) {
							return (
								...
								[2, this.collection(et.Catalog, 'search/hints', void 0, r)]
							);
						});
					});
				}),
				(API.prototype.song = function (e, t) {
					return __awaiter(this, void 0, void 0, function () {
						return __generator(this, function (r) {
							return (
								(t = this.equivalentParameters(t)),
								[2, this.resource(et.Catalog, 'songs', e, t)]
							);
						});
					});
				}),
					...
					return __awaiter(this, void 0, void 0, function () {
						return __generator(this, function (r) {
							return (
								...
								(t = this.equivalentParameters(t)),
								[2, this.collection(et.Catalog, 'songs', e, t)]
							);
						});
					});
				}),
	...
	var dt,
		pt = Ke.playbackBitrateDidChange,
		...
		mt = (function (t) {
			...
			return (
				...
				(Playback.prototype.timing = function (e) {
					return (
						void 0 === e && (e = 0),
						this._timingAccuracy === ct.ROUND ? Math.round(e) : e
					);
				}),
	...
	unwrapExports$1(jt);
	jt.arrayBufferToString,
		jt.base64ToUint8Array,
		jt.ensureArray,
		jt.stringToUint8Array,
		jt.stringToUint16Array,
		jt.uint8ArrayToBase64;
							...
							return n(this, function (n) {
								switch (n.label) {
									...
									case 1:
										return (
											n.trys.push([1, 3, , 4]),
											[4, i.apply(null, jt.ensureArray(e.params))]
										);
									case 2:
										return (
											(o = n.sent()),
	...
	var zt,
		Kt = 'https://authorize.music.apple.com',
	...
	!(function (e) {
		function StoreKit(t, r) {
			var i =
				e.call(this, [
					Ht.authorizationStatusDidChange,
					Ht.authorizationStatusWillChange,
					Ht.eligibleForSubscribeView,
					Ht.storefrontCountryCodeDidChange,
					Ht.userTokenDidChange,
				]) || this;
			return (
				(i.developerToken = t),
				(i.apiBase = 'https://api.music.apple.com/v1'),
				...
				(i.prefix = 'music'),
				(i.storage = window.localStorage),
				(i._authorizationStatus = xt.NOT_DETERMINED),
				(i._dispatchedSubscribeView = !1),
				r &&
					(r.deeplink && (i.deeplinkParameters = r.deeplink),
					r.persist && (i.persist = r.persist),
					r.prefix && (i.prefix = r.prefix)),
				(i._developerToken = new Ct(t)),
				(i._serviceSetupView = new Ft(t, {
					authenticateMethod: r && r.authenticateMethod,
					iconURL: r && r.iconURL,
					deeplinkParameters: i.deeplinkParameters,
				})),
				...
				i.userTokenIsValid &&
					...
					(i._authorizationStatus = i.restrictedEnabled
						...
						: xt.AUTHORIZED)),
				(i._storefrontCountryCode = i.storefrontCountryCode),
				It() || i._processLocationHash(window.location.hash),
				i
			);
		}
		__extends$1(StoreKit, e),
			Object.defineProperty(StoreKit.prototype, 'authorizationStatus', {
				...
				set: function (e) {
					this.dispatchEvent(Ht.authorizationStatusWillChange, {
						...
						(this._authorizationStatus = e),
						this.dispatchEvent(Ht.authorizationStatusDidChange, {
							authorizationStatus: e,
						});
				},
				enumerable: !0,
			...
			Object.defineProperty(StoreKit.prototype, 'restrictedEnabled', {
				...
				set: function (e) {
					this.userToken &&
						...
						this._setStorageItem(this.userToken + '.r', e ? '1' : '0'),
						(this._restrictedEnabled = e),
						e && (this.authorizationStatus = xt.RESTRICTED);
				},
				enumerable: !0,
				configurable: !0,
			}),
			Object.defineProperty(StoreKit.prototype, 'storefrontCountryCode', {
				...
				set: function (e) {
					e && this.userToken
						...
						: this._removeStorageItem(this.userToken + '.s'),
						(this._storefrontCountryCode = e),
						this.dispatchEvent(Ht.storefrontCountryCodeDidChange, {
							storefrontCountryCode: e,
						});
				},
				enumerable: !0,
			...
			Object.defineProperty(StoreKit.prototype, 'storefrontIdentifier', {
				...
				set: function (e) {
					(this._storefrontIdentifier = e),
						this.dispatchEvent(Ht.storefrontIdentifierDidChange, {
							storefrontIdentifier: e,
						});
				},
				enumerable: !0,
				...
				set: function (e) {
					e && validateToken(e)
						? ((this.authorizationStatus = this.restrictedEnabled
								...
								: xt.AUTHORIZED),
						  this._setStorageItem(this.storagePrefix + '.u', e))
						: ((this.authorizationStatus = xt.NOT_DETERMINED),
						  this._removeStorageItem(this.storagePrefix + '.u')),
						(this._userToken = e),
					...
					return __generator$1(this, function (t) {
						switch (t.label) {
							case 0:
								return this.storefrontIdentifier
									? [3, 2]
									: [4, Wt.inferFromLanguages(this.developerToken)];
							case 1:
								(e = t.sent()),
									(this.storefrontIdentifier = e.id),
									(t.label = 2);
						...
						return __generator$1(this, function (r) {
							switch (r.label) {
								case 0:
									...
									if (!e)
										return (
											this.dispatchEvent(Ht.eligibleForSubscribeView),
											(this._dispatchedSubscribeView = !0),
											[2]
										);
									r.label = 1;
					...
					get: function () {
						if (!this._byteRanges) {
							var e = (function (e) {
								...
								t = (function (e) {
									if (e && Qt.test(e))
										return e.match(Qt).map(function (e) {
	...
	var ir,
		...
		Tr = (function (e) {
			function BasePlayer(t, r) {
				...
				(i.privateEnabled = !1),
					(i.siriInitiated = !1),
					(i._bitrate = Zt.STANDARD),
					(i._currentBufferedProgress = 0),
					(i._paused = !1),
					(i._playbackState = er.none),
					(i._stopped = !1),
					(i._timingAccuracy = Jt.ROUND),
					...
					(i._bitrate = t.bitrate || Zt.STANDARD),
					(i._timingAccuracy = t.accurateTiming ? Jt.ACCURATE : Jt.ROUND),
					window.navigator &&
				...
				return (
					...
					localStorage.setItem(ar, i._serial),
					setTimeout(function () {
						i.playActivity.activate(!i.isPlaying);
					}, 500),
					i
			...
			return (
					...
					set: function (e) {
						e !== this._isPrimaryPlayer &&
							...
							this._isPrimaryPlayer
								? localStorage.setItem(ar, this._serial)
					...
					get: function () {
						return this._storekit &&
							...
							? (this._playActivityClient ||
									(this._playActivityClient = new be(
				...
				(BasePlayer.prototype._recalculateBitrate = function (e) {
					this._downlinkSamples.push(e),
						this.medianDownlink && this.medianDownlink >= 65
							? (this.bitrate = Zt.HIGH)
							: (this.bitrate = Zt.STANDARD);
				}),
				...
				(BasePlayer.prototype._timing = function (e) {
					return (
						void 0 === e && (e = 0),
						this._timingAccuracy === Jt.ROUND ? Math.round(e) : e
					);
				}),
				BasePlayer
			);
	...
	var Ar,
		...
		Or = (function (e) {
			function KeySession() {
				var t =
					e.call(this, [or.playbackLicenseError, or.playbackSessionError]) ||
					this;
				return (
					(t.initiated = !0),
					(t.isLibrary = !1),
					(t.keySystem = nr.FAIRPLAY),
				...
				(KeySession.prototype._handleLicenseResponse = function (e, t, r) {
					...
					if (e.license) {
						...
						const recreateFix = async () => {
							console.log('Running: recreateFix, id:', id);
							...
							if (
								...
								console.log(
									`${id} !== ${instance.player._currentPlayer.extension.session._session.sessionId}`
								);
								return;
							}
							...
							try {
								...
								try {
									if (isplaying) await instance.player._currentPlayer.stop();
								} catch (e) {}
								await instance.player._currentPlayer.recreate();
								await instance.player.changeToMediaAtIndex(index);
								await instance.player.playAndSeekToTimeWhenBuffered(
									time,
									isplaying
								);
							} catch (e) {
		...
		jr = (function (e) {
			function MediaExtension(t, r) {
				...
				if (
					...
					window.WebKitMediaKeys.isTypeSupported(nr.FAIRPLAY + '.1_0', ir.MP4)
				)
					(i.session = new Nr()),
					...
					window.MSMediaKeys &&
					window.MSMediaKeys.isTypeSupported(nr.PLAYREADY, ir.MP4)
				)
					(i.session = new Lr()),
						i.session.attachMedia(t, {
					...
					navigator
						.requestMediaKeySystemAccess(nr.WIDEVINE, n)
						.then(function (e) {
							i.session.attachMedia(t, e);
						})
						.catch(function () {
							navigator
								.requestMediaKeySystemAccess(nr.PLAYREADY, n)
								.then(function (e) {
									i.session.attachMedia(t, e);
								});
						});
				...
				return (
					i.session &&
						i.session.addEventListener(or.playbackLicenseError, function (e) {
		...
		Zr = (function (e) {
			...
			return (
				...
				(AudioPlayer.prototype.create = function () {
					...
					(r.extension = new jr(i, Pe)),
						r.extension.addEventListener(or.playbackLicenseError, function (e) {
				...
				(AudioPlayer.prototype.destroy = function (soft) {
					...
					return (
						...
						e.extension.session.destroy().then(function () {
							e.audio.src = '';
				...
				(AudioPlayer.prototype.recreate = function () {
					var r = this;
					return r.destroy(true).then(function () {
						return r.create();
					});
					//.then(function(){
				...
				(AudioPlayer.prototype.playMediaItem = function () {
					...
					if (
						this.extension.session._session &&
						this.extension.session._session.expiration &&
						arg[0] &&
						arg[0].playbackDuration
					) {
						...
						if (
							...
							this.extension.session._session.expiration <=
								Date.now() + arg[0].playbackDuration + 100
						) {
						...
						return __generator(this, function (r) {
							switch (e.type) {
								...
								case 'seeking':
									this.playbackState === Hr
										? (this._paused = !0)
										: this.playbackState === Yr && (this._stopped = !0),
				...
				return (
					...
					(PlaybackMonitor.prototype.clearListeners = function () {
						this._playbackController.removeEventListener(
							Ke.playbackDurationDidChange,
							this._boundUpdateThreshhold
						),
							this._playbackController.removeEventListener(
								Ke.playbackTimeDidChange,
	...
	!(function (e) {
		...
		((Dr = e.PlayerSeek || (e.PlayerSeek = {}))[(Dr.FORWARD = 30)] = 'FORWARD'),
		(Dr[(Dr.BACK = 15)] = 'BACK');
	var Jr = Ke.bufferedProgressDidChange,
		...
		gi = (function (t) {
			function SerialPlayback(r) {
				...
				return (
					...
					(i._queue = new wt({})),
					(i._repeatMode = Ar.none),
					(i._shuffleMode = Cr.off),
					(i._storekit = r.storekit),
					(i._playerOptions = r),
					(i._playersByType = {}),
					(i._currentPlayer = i._getPlayerByType('audio') || new Ir()),
					(i._preloader = new Xr(i)),
					i
				);
			}
			return (
				...
				Object.defineProperty(SerialPlayback.prototype, 'queue', {
					...
					set: function (e) {
						...
						this.hasAuthorization &&
							...
							this.shuffleMode === Cr.songs && e.shuffle(!1),
						...
						r &&
							...
							this._currentPlayer
								...
								.catch(function () {}),
							e.addEventListener(bi, function (e) {
				...
				Object.defineProperty(SerialPlayback.prototype, 'repeatMode', {
					...
					set: function (e) {
						(this._repeatMode = e),
							this._updatePlayerState('isLooping', this._repeatMode === Ar.one);
					},
					enumerable: !0,
					configurable: !0,
				}),
				...
				Object.defineProperty(SerialPlayback.prototype, 'shuffleMode', {
					...
					set: function (e) {
						e !== this._shuffleMode &&
							((this._shuffleMode = e),
							e === Cr.songs ? this.queue.shuffle() : this.queue.unshuffle(),
							this.nowPlayingItem &&
				...
				Object.defineProperty(SerialPlayback.prototype, 'storekit', {
					...
					set: function (e) {
						...
						e &&
							(e.addEventListener(
								Be.authorizationStatusWillChange,
								function (e) {
									var r = e.authorizationStatus,
										i = e.newAuthorizationStatus;
									return __awaiter(t, void 0, void 0, function () {
				...
				(SerialPlayback.prototype.playAndSeekToTimeWhenBuffered =
					async function (seekTime, playAfter) {
						(this._playerState[e] = t), (this._currentPlayer[e] = t);
						...
						return new Promise(async (resolve, reject) => {
							try {
								...
								const seekThreshold = Math.min(
									calculatedPercentForSafeSeek,
									100
								);
		...
		wi = (function (t) {
			function MusicKitInstance(r, i) {
				...
				return (
					o.addEventListener(Ke.authorizationStatusDidChange, function (e) {
					...
					o.addEventListener(Ke.userTokenDidChange, function (e) {
						n._api && (n._api.clearCacheItems(), (n._api = void 0)),
							n.dispatchEvent(Ke.userTokenDidChange, e);
					}),
			...
			return (
					...
					get: function () {
						...
						if (!this._player) {
							...
							this._player.addEventListener(u, function (e) {
								...
								[r, i, n, o, a, s, c, y, l, d, h, f, m, b].forEach(function (
									e
								) {
				...
				(MusicKitInstance.prototype._handlePlaybackError = function (e) {
					we.logger.log('mediaPlaybackError', e),
						this.dispatchEvent(Ke.mediaPlaybackError, e),
	...
	function configure(e) {
		...
		return (
			...
			dispatchDocumentEvent(Ke.configured),
			Ai
		);
	}
	if (Di) {
